...
Model_Production7 <- lme(DeficitFruitSet ~ Apple_variety * Location * Year, random = ~1|Tree/Location, data = PollinationDeficit2)
summary(Model_Production7)
